...
const Experience = () => {
  return (
    <div className='my-20 mx-20' id='experience'>
      ...
      <div className='my-10 lg:mx-20 flex items-center '>
        <div className='flex items-center flex-col my-20 border-2 mx-4 border-black lg:w-[30%] p-10 rounded-xl'>
        ...
        <div className='flex items-center flex-col my-20 border-2 mx-4 border-black lg:w-[30%] p-10 rounded-xl'>
            <h5 className='font-bold text-2xl'>Forse Reklam</h5>
            <p className='my-2 '>Web Programmer </p>
            <p className='text-sm  opacity-40'>(August 2023 - )</p>
        </div>
